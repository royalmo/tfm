...
physical loop. In the reported runtime logs, almost all solves finish
within one sampling period and all recorded solves finish before the
next replanning deadline imposed by the turn length, although the
slowest replans still leave limited slack.
They also reveal a systematic gap between planned acceleration-domain
