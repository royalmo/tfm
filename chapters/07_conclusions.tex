...
physical loop, although not with large timing margin: solves often take
longer than one sampling period and therefore rely on the remaining
turn-length buffer to finish before the next mandatory refresh.
