...
he structure of this thesis reflects the dual nature of its approach. Following the background
presentation, the thesis branches into two main parts, each dedicated to one of the case studies:

\begin{itemize}
    \item In \cref{ch:background}, we present the background and related work relevant to the thesis.
    \item In \cref{ch:goop}, we introduce the challenges of finding solutions to games of ordered preference.
    \item In \cref{ch:lex-ibr-ot}, we present our contributions towards improving the tractability of computing solutions to games of ordered preference.
    \item In \cref{ch:estimation}, we 
    \item In \cref{ch:duckietown}, we present our contributions to making a simple physical test environment for 
    \item In \cref{ch:conclusions}, we summarize the main findings of this thesis and discuss potential avenues for future work.
\end{itemize}
